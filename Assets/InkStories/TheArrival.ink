...
~letterSent=true
-else:
    The women holds her hand out as if asking for money, you will need to change your money into the local currency
}
->postOffice
...
=askForMoney
Ask for money to send the letter home
->buchannanStStation
...
*[Give English letter]->letter
*[Convey hunger]->hunger
+[Back]->menu
